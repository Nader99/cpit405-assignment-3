...
document.getElementById("popular").addEventListener("click", function sortElements() {
sorted_img = images.sort(function (a, b ){return b.likes- a.likes});
});
// Generate the sorted array using the DOM API
document.getElementById("popular").addEventListener("click", function createDomElem( ){
removeElement("div");
var divElem = document.createElement("div");
divElem.id ="div";
var imgElem = document.createElement("img");
...
document.getElementById("newest").addEventListener("click",function sortElements() {
sorted_img = images.sort(function(a, b){return +new Date(b.dateUploaded) - +new Date(a.dateUploaded);});   
});
// Generate the sorted array using the DOM API
document.getElementById("newest").addEventListener("click",function createDomElem(){
removeElement("div");
var divElem = document.createElement("div");
divElem.id ="div";
var imgElem = document.createElement("img");
...
document.getElementById("size").addEventListener("click",function sortElements() {
sorted_img = images.sort(function(a, b){return b.size - a.size;});   
});
// Generate the sorted array using the DOM API
document.getElementById("size").addEventListener("click",function createDomElem(){
removeElement("div");
var divElem = document.createElement("div");
divElem.id ="div";
var imgElem = document.createElement("img");
...
document.getElementById("views").addEventListener("click",function sortElements() {
sorted_img = images.sort(function(a, b){return b.views - a.views;}); 
});
// Generate the sorted array using the DOM API
document.getElementById("views").addEventListener("click",function createDomElem(){
removeElement("div");
var divElem = document.createElement("div");
divElem.id ="div";
var imgElem = document.createElement("img");
